...
class MockDaemon(object):
    ...
    def run_cmd(self, argv):
        ...
        # invoice:
        i_help = "Create an invoice for {msatoshi} with {label} and {description} with optional {expiry} seconds (default 1 hour) and optional {preimage} (default autogenerated)"
        parser_inv = subparsers.add_parser('invoice', help=i_help)
        ...
        parser_paid = subparsers.add_parser('markpaid',
                                            help='mark invoice as paid')
